...
<template>
  <div class="w-full h-full flex flex-1 flex-col overflow-hidden">
    <appHeader
      @test="test"
      ref="header"
    ...
    >
      <div
        class="max-width-screen w-full flex absolute px-4 bottom-0 h-10 items-center text-3xl m-auto font-bold txtDark_Primary"
      >
    ...
    <div
      ref="scrollView"
      class="w-full h-full flex-1 pb-16 overflow-auto overscrollBehaviorNone"
      @scroll="handleScroll(scrollView, $event)"
      @scrollend="handleScrollEnd(scrollView, $event)"
