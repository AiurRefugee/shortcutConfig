...
<template>
  ...
  <div
    ref="searchWrapper"
    id="searchBar"
    class="sticky z-40 overflow-visible fastTrans"
    :style="{
      top: inputFocus ? '0' : '2rem',
    }"
  >
    <div class="w-full bgLight_Primary pt-2 pb-3 px-2">
      <div
        class="max-w-screen m-auto bgLight_Primary w-full flex items-center px-2"
      >
        <div
